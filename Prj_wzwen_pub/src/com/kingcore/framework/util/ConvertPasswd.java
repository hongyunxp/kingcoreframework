...
/**
 * @author zewen.wu
 * @deprecated by ConvertPassword.java
 * To change this generated comment edit the template variable "typecomment":
 * Window>Preferences>Java>Templates.
 * To enable and disable the creation of type comments go to
 * Window>Preferences>Java>Code Generation.
 */
public class ConvertPasswd
{
    /**
     * 密码加密
     ...
     */
    public static String expressPasswd(String psPass) throws Exception
    {
     ...
     */
    public static String expandPasswd(String passwd) throws Exception
    {
