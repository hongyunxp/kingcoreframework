...
public class J2MainMenuTag extends TagSupport{

    public String filePath = "jsp/conf/main_menu.xml";
    private String realPath = "wen/jsp/conf/main_menu.xml";
    ...
    public int doEndTag() throws JspException {
        ...
        this.realPath = this.pageContext.getServletContext().getRealPath(this.getFilePath()) ;
		doProcess(sbHtml) ;
		...
		{
			p("error happened when write to jsp page!") ;
		}
        return EVAL_PAGE;
    }
