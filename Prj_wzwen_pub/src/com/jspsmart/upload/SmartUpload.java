...
public class SmartUpload
{
    ...
    private static String charSet = "iso8859-1"; //modify wangxinlin
        ...
        throws SmartUploadException, IOException, ServletException
    {
        ...
        do
        {
            ...
            {
                String value = new String(m_binArray, m_startData, (m_endData - m_startData) + 1,this.charSet);
    ...
    private String getDataHeader()
    {
        ...
        String dataHeader = "";
		try {
			dataHeader = new String(m_binArray, start, (end - start) + 1,this.charSet);
